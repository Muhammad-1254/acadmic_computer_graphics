...
BOOL ReadWavFile(const CHAR* pFileName, PWAV pWav)
{
	typedef struct {
...
HWAV PlayWavFile(const char* filename, BOOL bLoop)
{
	PWAV pWav = NULL;
...
void PlayBackgroundSound(const char* filename)
{
...
void PlayForegroundSound(const char* filename)
{
	HWAV hWav = NULL;
